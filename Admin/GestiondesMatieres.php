...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="gestionDesMatieres.css">
...
<section class="milieuDePage">
            ...
            <div class="menu-part">
                ...
                <div class="utilisateur">
                    <div class="utilisateur-box-prof" onclick="redirigerVersAutrePage1()">
                        ...
                        <h6 class="user-texte-prof">Modifier les matières</h6>
  ...
  function redirigerVersAutrePage1() {
    var urlDestination = './modificationMatieres.php';
    window.location.href = urlDestination;
                ...
                <div class="utilisateur">
                    <div class="utilisateur-box-prof" onclick="redirigerVersAutrePage2()">
                        <a href="./gestionDesProfs.php" class="user-link"> </a>
                        <h6 class="user-texte-prof">Voir la liste des matières</h6>
                        <div><i class="fa-solid fa-window-restore"></i></div>
                    </div>
                </div>

                <script>
  function redirigerVersAutrePage2() {
    var urlDestination = './listeDesMatieres.php';
    window.location.href = urlDestination;
  }
</script>
